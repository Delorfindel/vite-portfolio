...
<template>
  <div id="smooth-wrapper">
    <div id="smooth-content">
      <div id="app-wrapper" class="flex flex-row items-start justify-between">
        <div class="w-3/4">
          <HorizontalSection />
          <CodeSection />
          <ThirdSection />
        ...
        <div class="flex flex-col w-1/4 h-screen border-white cursive newnavbar">
          <span class="text-7xl title">DANY<br>GANTIER</span>
          <span class="text-base no-cursive subtitle">PORTFOLIO © 2022</span>
        </div>
      </div>
      <!-- <TheHeader /> -->
    </div>
